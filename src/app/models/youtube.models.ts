// To parse this data:
//
//   import { Convert, YoutubeResponde } from "./file";
//
//   const youtubeResponde = Convert.toYoutubeResponde(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface YoutubeResponde {
    kind:     string;
    etag:     string;
    pageInfo: PageInfo;
    items:    Item[];
...
export class Convert {
    public static toYoutubeResponde(json: string): YoutubeResponde {
        return cast(JSON.parse(json), r("YoutubeResponde"));
    }

    public static youtubeRespondeToJson(value: YoutubeResponde): string {
        return JSON.stringify(uncast(value, r("YoutubeResponde")), null, 2);
    }
}
